...
use notist_analysis::{
    ...
    ModuleId, RefTarget, WorkspaceSnapshot,
};
...
/// heading alters: the authoritative id list paired with the section spans, so
/// `locate`, segment identity and the refs region map agree with `--item`.
